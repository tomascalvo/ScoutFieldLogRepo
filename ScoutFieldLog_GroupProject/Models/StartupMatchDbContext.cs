...
{
    public partial class StartupMatchDbContext : DbContext
    {
        public StartupMatchDbContext()
        {
        }

        public StartupMatchDbContext(DbContextOptions<StartupMatchDbContext> options)
            : base(options)
        {
        }
